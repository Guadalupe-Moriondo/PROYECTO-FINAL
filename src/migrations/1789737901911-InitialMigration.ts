...
export class InitialMigration1789737901911 implements MigrationInterface {
    name = 'InitialMigration1789737901911'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`categories\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(100) NOT NULL, \`description\` text NULL, \`active\` tinyint NOT NULL DEFAULT 1, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`products\` (\`id\` int NOT NULL AUTO_INCREMENT, \`code\` varchar(50) NOT NULL, \`name\` varchar(150) NOT NULL, \`description\` text NULL, \`machineryCompatibility\` text NULL, \`price\` decimal(10,2) NOT NULL, \`stock\` int NOT NULL DEFAULT '0', \`min_stock\` int NOT NULL DEFAULT '5', \`imageUrl\` varchar(255) NULL, \`active\` tinyint NOT NULL DEFAULT 1, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`category_id\` int NULL, UNIQUE INDEX \`IDX_7cfc24d6c24f0ec91294003d6b\` (\`code\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(150) NOT NULL, \`email\` varchar(150) NOT NULL, \`password_hash\` varchar(255) NOT NULL, \`role\` enum ('customer', 'admin') NOT NULL DEFAULT 'customer', \`owner\` tinyint NOT NULL DEFAULT 0, \`tokenVersion\` int NOT NULL DEFAULT '0', \`phone\` varchar(255) NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_97672ac88f789774dd47f7c8be\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`orders\` (\`id\` int NOT NULL AUTO_INCREMENT, \`order_number\` varchar(255) NOT NULL, \`status\` enum ('pending', 'confirmed', 'in_preparation', 'withdraw', 'delivered') NOT NULL DEFAULT 'pending', \`payment_method\` enum ('cash', 'transfer', 'card') NOT NULL, \`total\` decimal(10,2) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`customerNotified\` tinyint NOT NULL DEFAULT 0, \`notificationMethod\` varchar(255) NULL, \`customerNotifiedAt\` timestamp NULL, \`user_id\` int NULL, UNIQUE INDEX \`IDX_75eba1c6b1a66b09f2a97e6927\` (\`order_number\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`business\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(150) NOT NULL, \`address\` varchar(255) NULL, \`city\` varchar(255) NULL, \`province\` varchar(255) NULL, \`country\` varchar(255) NULL, \`phone\` varchar(255) NULL, \`whatsapp\` varchar(255) NULL, \`morningOpen\` varchar(255) NULL, \`morningClose\` varchar(255) NULL, \`afternoonOpen\` varchar(255) NULL, \`afternoonClose\` varchar(255) NULL, \`saturdayOpen\` varchar(255) NULL, \`saturdayClose\` varchar(255) NULL, \`instagram\` varchar(255) NULL, \`facebook\` varchar(255) NULL, \`email\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
