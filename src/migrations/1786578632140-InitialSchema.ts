...
export class InitialSchema1786578632140 implements MigrationInterface {
    name = 'InitialSchema1786578632140'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(150) NOT NULL, \`email\` varchar(150) NOT NULL, \`password_hash\` varchar(255) NOT NULL, \`role\` enum ('customer', 'admin') NOT NULL DEFAULT 'customer', \`owner\` tinyint NOT NULL DEFAULT 0, \`phone\` varchar(255) NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_97672ac88f789774dd47f7c8be\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`categories\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(100) NOT NULL, \`description\` text NULL, \`machineType\` varchar(20) NOT NULL DEFAULT 'otros', \`active\` tinyint NOT NULL DEFAULT 1, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`business\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(150) NOT NULL, \`address\` varchar(255) NULL, \`city\` varchar(255) NULL, \`province\` varchar(255) NULL, \`country\` varchar(255) NULL, \`phone\` varchar(255) NULL, \`whatsapp\` varchar(255) NULL, \`mondayOpen\` varchar(255) NULL, \`mondayClose\` varchar(255) NULL, \`afternoonOpen\` varchar(255) NULL, \`afternoonClose\` varchar(255) NULL, \`saturdayOpen\` varchar(255) NULL, \`saturdayClose\` varchar(255) NULL, \`instagram\` varchar(255) NULL, \`facebook\` varchar(255) NULL, \`email\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
